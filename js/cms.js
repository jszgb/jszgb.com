  ...
  setNavigation: function () {
    ...
    CMS.settings.siteNavItems.forEach(function (navItem) {
      if (navItem.hasOwnProperty('href')) {
        ...
        if (navItem.hasOwnProperty('className')) {
          navBuilder.push('class="', navItem.className, '"')
        }
        navBuilder.push('><span>', navItem.name, '</span></a></li>')
      } else {
        CMS.pages.forEach(function (page) {
          if (navItem.name === page.title) {
            navBuilder.push('<li><a href="#" class="cms_nav_link" id="', navItem.name, '"><span>', navItem.name, '</span></a></li>')
          }
        })
      }
    })
